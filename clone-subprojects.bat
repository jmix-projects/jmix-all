...
git clone https://github.com/Haulmont/jmix-cloudqueue.git
git clone https://github.com/Haulmont/jmix-core.git
git clone https://github.com/Haulmont/jmix-cuba.git
git clone https://github.com/Haulmont/jmix-dashboards.git
git clone https://github.com/Haulmont/jmix-data.git
git clone https://github.com/Haulmont/jmix-dataimport.git
...
git clone https://github.com/Haulmont/jmix-search.git
